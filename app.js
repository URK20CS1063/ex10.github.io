...
res.writeHead(200, {'Content-type':'text/html'})
res.write("<table border=1 cellspacing=0><tr><th>FieldName</th><th>Value</th></tr>")

res.write("<tr><td>Name </td><td>" + inputdata.get('username') +

"</td></tr>")

res.write("<td>Password </td><td>" + inputdata.get('password') +

"</td></tr>")

res.write("<td>Age </td><td>" + inputdata.get('age') + "</td></tr>")
res.write("<td>Mobile Number </td><td>" + inputdata.get('number') +

"</td></tr>")

res.write("<td>Email </td><td>" + inputdata.get('email') +

"</td></tr>")

res.write("<td>Gender </td><td>" + inputdata.get('gender') +

"</td></tr>")

res.write("<td>State </td><td>" + inputdata.get('state') +
